...
function showResults() {
    ...
    const previousStandings = Object.entries(teams)
        .map(([team, score]) => ({
            team,
            previousScore: score,  // This is now the current total score
            currentRoundScore: getCurrentRoundScore(team),
            totalScore: score + getCurrentRoundScore(team),  // This will be the new total after adding current round
            initialRank: 0
        }))
