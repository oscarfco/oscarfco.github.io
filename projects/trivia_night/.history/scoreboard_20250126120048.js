...
function startGame() {
        ...
        <div class="game-container">
            ...
            ${Object.entries(teams).map(([team, data]) => `
                <div class="game-team-row">
                    ...
                    <span class="team-name" style="color: ${teamColors[team]} !important">${team}</span>
    ...
    // Move the stopwatch element after the buttons
    const gameScreen = document.getElementById('gameScreen');
    const stopwatch = gameScreen.querySelector('.stopwatch');
    const endGameBtn = gameScreen.querySelector('.end-game-btn');
    
    if (stopwatch && endGameBtn) {
        endGameBtn.after(stopwatch);
    }
