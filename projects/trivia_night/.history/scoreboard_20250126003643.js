    ...
    scoreBoard.innerHTML = `
        ...
        <div class="timer-container">
            <div class="timer-controls">
                <button onclick="adjustTimer('minutes', 1)">+</button>
                <span id="minutes">05</span>:
                <span id="seconds">00</span>
                <button onclick="adjustTimer('minutes', -1)">-</button>
                <button onclick="adjustTimer('seconds', 1)">+</button>
                <button onclick="adjustTimer('seconds', -1)">-</button>
            </div>
            <button id="startRoundBtn" onclick="startRoundTimer()">Start Round</button>
        </div>
