...
function startGame() {
    ...
    // Add stopwatch HTML
    const stopwatchHTML = `
        <div class="stopwatch-container" style="margin: 20px auto;">
            <div class="stopwatch">
    ...
    // Insert stopwatch at the end of scoreBoard instead of body
    scoreBoard.insertAdjacentHTML('beforeend', stopwatchHTML);
