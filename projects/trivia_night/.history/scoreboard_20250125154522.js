...
function drawRankingGraph() {
    ...
    const ySpacingFactor = 1.0; // Increase this value to add more space between y-labels
    ...
    const yScale = (pos) => {
        ...
        // Calculate the space between each position, multiplied by the spacing factor
