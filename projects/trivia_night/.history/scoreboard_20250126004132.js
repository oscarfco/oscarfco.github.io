...
function initDraggableStopwatch() {
    ...
    setTranslate(40, window.innerHeight / 2 - stopwatch.offsetHeight / 2, stopwatch);

    stopwatch.addEventListener('mousedown', dragStart);
    ...
    function dragStart(e) {
        ...
        if (e.target === stopwatch || stopwatch.contains(e.target)) {
            isDragging = true;
    ...
    function drag(e) {
        if (isDragging) {
            ...
            setTranslate(currentX, currentY, stopwatch);
        }
    }
    ...
    function setTranslate(xPos, yPos, el) {
        // Keep stopwatch within viewport bounds
